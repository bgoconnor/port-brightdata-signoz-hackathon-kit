/* Ported from the design handoff (pf-list.jsx) to ES modules.
...
import { Hero, WorkflowViz } from "./hero.jsx";
import { Notice, PF_ORDER, ScoreBar, SectionHead, StatusChip, pfAgo, pfAuthors, pfStatus } from "./ui.jsx";

/* Paper Factory — Screen 1: Pipeline */

export function StatStrip({ summary, list }) {
...
export function FilterBar({ counts, active, onStatus, repOnly, onRep, query, onQuery }) {
...
export function PaperRow({ p, onOpen }) {
...
export function PipelineScreen({ list, summary, notice, onOpen, onWaitlist }) {
