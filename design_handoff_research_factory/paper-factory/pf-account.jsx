...
const PF_SUBJECTS = ["cs.LG", "cs.CL", "cs.CV", "cs.AI", "stat.ML", "cs.RO", "cs.IR", "cs.SE", "cs.NE"];
const PF_SOURCES = [
...
function WaitlistScreen({ onBack }) {
...
function SignInScreen({ onBack, onSignedIn, onWaitlist }) {
  const [email, setEmail] = React.useState("");
  return (
    <div className="pf-wrap pf-narrow">
      <button className="pf-back" onClick={onBack}>&larr; factory</button>
...
Object.assign(window, { WaitlistScreen, SignInScreen, SettingsScreen, ConfigFields, Field, ChipPick, CheckList, KeywordInput, PF_SUBJECTS, PF_SOURCES, PF_INTEGRATIONS });
