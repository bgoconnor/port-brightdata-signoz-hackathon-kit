...
function ReviewBar({ paper, busy, onDecide }) {
...
function DetailScreen({ paper, stub, notice, loading, onBack, onDecide, busy }) {
  const p = paper || stub;
  if (!p) {
    return (
...
Object.assign(window, { DetailScreen, ReviewBar, AttemptCard, ReproSummary, pfErrLine });
