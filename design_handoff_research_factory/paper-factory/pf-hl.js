/* Paper Factory — Python tokenizer for syntax highlighting.
   Returns tokens, never HTML: the renderer emits React text nodes, so
   scraped/generated content can never be interpreted as markup. */
(function () {
  ...
  window.PFHighlight = { tokenize: tokenize, lines: lines };
})();
